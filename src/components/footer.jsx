  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    ...
    <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div class="mx-auto max-w-sm lg:max-w-none">
        ...
        Ekotracka is your sustainable waste management solution in Lagos. We aim to
              efficiently manage waste by recycling and disposing of it in an eco-friendly manner.
              Join us in creating a cleaner and greener environment for all.
        </p>
