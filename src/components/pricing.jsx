          ...
          <div className="lg:flex items-center justify-between">
            <div className="lg:w-1/2 w-full">
              ...
              <p role="contentinfo" className="text-base leading-5 mt-5 text-gray-600">
                At Ekotracka, we're committed to providing accessible waste management solutions. We're constantly making available a suite of tools to make managing waste easier, whether you're an individual, a building owner, or an organization. We can't wait to hear what you think.
              </p>
              <div className="w-56">
            ...
            <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
              ...
              <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg p-8 relative z-30">
                <div className="md:flex items-center justify-between">
                  <h2 className="text-2xl font-semibold leading-6 text-gray-800">Individual</h2>
                  <p className="text-2xl font-semibold md:mt-0 mt-4 leading-6 text-gray-800">FREE</p>
                </div>
                <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Full access to all waste management features with no credit card required.</p>
              </div>
              <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                ...
                <div className="w-full p-8">
                  <div className="md:flex items-center justify-between">
                    <h2 className="text-2xl font-semibold leading-6 text-gray-800">Building</h2>
                    <p className="text-2xl md:mt-0 mt-4 font-semibold leading-6 text-gray-800">
                      $18<span className="font-normal text-base">/mo</span>
                    </p>
                  </div>
                  <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Unlimited waste management features and incentives dedicated support channels.</p>
                </div>
              </div>
              <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg p-8 relative z-30 mt-7">
                <div className="md:flex items-center justify-between">
                  <h2 className="text-2xl font-semibold leading-6 text-gray-800">Organization</h2>
                  <p className="text-2xl md:mt-0 mt-4 font-semibold leading-6 text-gray-800">
                    $25<span className="font-normal text-base">/mo</span>
                  </p>
                </div>
                <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Unlimited waste management-plus and incentive features and dedicated support channels.</p>
              </div>
            </div>
          </div>
        </div>
